...
//
//   node video/engine/scripts/tts-elevenlabs.mjs [--scene s01-hook,s05-correlate] [--force]
//   node video/engine/scripts/tts-elevenlabs.mjs --audition --voices <id>,<id> [--model eleven_v3]
//
