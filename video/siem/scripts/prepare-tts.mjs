...
//
//   node video/siem/scripts/prepare-tts.mjs [--narration P] [--lexicon P] [--storyboard P] [--out P]
//     -> writes out/tts-input.json: [{ id, scene, voice, rate, pitch, spoken, key }]
//   node video/siem/scripts/prepare-tts.mjs --audition [--lexicon P]
...
export const AUDITION_TEXT =
  'Prueba de voz para el vídeo sobre el SIEM de la Autoridad Portuaria de Halden. ' +
